			...
			<Container>
				...
				<Row>
					<span>
						...
						suis actuellement à la recherche d'un stage pour mars 2025, d'une
				...
				<Row>
					<span>
						...
						des sites web, principalement en Java / JEE, mais aussi en
						Javascript avec des frameworks comme Express ou React. En réalisant
						ces projets, j'ai eu l'opportunité de plonger concrètement dans
						l'application des méthodes agiles. J'ai également réalisé un stage
						au sein de mon établissement lors de ma deuxième année.
					</span>
				</Row>
				<Row>
					<span>
						...
						de mettre en pratique mes compétences techniques et de les enrichir,
						tout en acquérant l'expertise d'une entreprise.
					</span>
				</Row>
			</Container>
		</section>
